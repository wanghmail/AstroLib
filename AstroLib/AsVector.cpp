...
//数乘矢量
const CVector<double> AsMNamespace operator *(double num, const CVector<double>& v)
{
...
//三维矢量的夹角(0..PI)
double AsMNamespace AsAngBetween(const CVector<double> &v1, const CVector<double> &v2)
{
	double w1 = v1.Norm();
	double w2 = v2.Norm();
